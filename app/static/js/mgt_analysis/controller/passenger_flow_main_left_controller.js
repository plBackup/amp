ampApp.controller("passenger-flow-main-left-controller",["$scope","$rootScope","$ampDocumentReady",function($scope,$rootScope,$ampDocumentReady){
    ...
    function initPageView(){
        container = $("#passenger-flow-main-left");
    ...
    function bindPageEvents(){
        ...
        container.on("click touchend","a.enrolment-btn",function(e){
            e.stopPropagation();
            e.preventDefault();
            window.location="#/passenger_flow_main_enrolment"
        });
