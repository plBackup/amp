ampApp.controller("cost-manual-work-left-controller",["$scope","$rootScope","$ampDocumentReady",function($scope,$rootScope,$ampDocumentReady){
    ...
    function initPageView(){
        container = $("#cost-manual-work-left");
    ...
    function bindPageEvents(){
        container.on("click touchend","a.enrolment-btn",function(e){
            e.stopPropagation();
            e.preventDefault();
            $rootScope.$broadcast("cost-manual-work.enrolment");
        });
    }
