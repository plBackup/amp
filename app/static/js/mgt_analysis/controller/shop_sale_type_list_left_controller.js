ampApp.controller("shop-sale-type-list-left-controller",["$scope","$rootScope","$ampDocumentReady",function($scope,$rootScope,$ampDocumentReady){
    ...
    function initPageView(){
        container = $("#shop-sale-type-list-left");
    ...
    function bindPageEvents(){
        ...
        container.on("click touchend","a.enrolment-btn",function(e){
            e.stopPropagation();
            e.preventDefault();
            $rootScope.$broadcast("shop-sale-type.enrolment");
        });
    }
