ampApp.controller("contract-main-left-controller",["$scope","$rootScope","$ampDocumentReady",function($scope,$rootScope,$ampDocumentReady){
    ...
    function reset(){
        ...
        var dateString = year+"-"+(currentDate.getMonth()+1)+"-"+currentDate.getDate();
